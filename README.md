...
| Шум (раидо настроено близко к станции) |   Radio_NearStation    | Шум переключения частоты радио, но радио почти улавливает радио | Игрок настраивает частоту радио крутя крутилку и почти ловит |
