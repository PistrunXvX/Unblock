...
|    2     | ~~[Система тайм-лайна](#гсистема-таймлайна)~~ (Не полностью) |     [Система диалогов](#гсистемадиалогов)     |
|    3     |                   ~~[Стамины](#стамины)~~                    | [Стационарный телефон](#гстационарныйтелефон) |
|    4     | ~~[Работа](#гработа) / [Рубильник](#грубильник)~~ (Не полностью?) |          [Щиток света](#гщитоксвета)          |
|    5     |      ~~[Список клиентов](#гсписокклиентов)~~ (Фиксить)       |                                               |
|    6     |                     [Игрушка](#гигрушка)                     |                                               |
|    7     |                        [Часы](#гчасы)                        |                                               |
|    8     |                       [Радио](#градио)                       |                                               |
...
- **Часы:**
  ...
  | :--------: | :-------------: | :---------------------------------------: | :----------------------------------------------------------: |
  |  Работают  | TickTack_Clock  | Очень тихий звук тикание минутной стрелки | Издается каждые 1.25 секунды и сопровождает внутриигровое время |

- **Шлагбаум:**

  | Состояние:  |    Название звука:    |                       Описание звука:                        |                         Поче-е-ему?                          |
  | :---------: | :-------------------: | :----------------------------------------------------------: | :----------------------------------------------------------: |
  |   Открыть   |    Open_PointCheck    | Звук будто открывается скрипучая дверь или гаражные ворота, но не очень протяженный и не громкий | Сразу после нажатия издается этот звук и сопровождает до полного открытия |
  | Открывается | OpenDanger_PointCheck | Звук маленьких колоколов или очень лайтового будильника на телефоне | Во время открытия шлагбаума и пока машина не проедет мигает лампочка и издает этот звук |
  | Закрывается |   Close_PointCheck    | Звук будто закрывается скрипучая дверь или гаражные ворота, но не очень протяженный и не громкий | Сразу после нажатия издается этот звук и сопровождается до полного закрытия |

- **Рубильник:**

  |        Состояние:         | Название звука: |                       Описание звука:                        |                Поче-е-ему?                 |
  | :-----------------------: | :-------------: | :----------------------------------------------------------: | :----------------------------------------: |
  | Нажатие на кнопку открыть |  Click1_Panel   | Легкий звук нажатия на большую кнопки сопровожденный очень легким звуком тока элекричества | Срабатывает мгновенно после нажатия кнопки |
  | Нажатие на кнопку закрыть |  Click1_Panel   | Легкий звук нажатия на большую кнопки сопровожденный очень легким звуком тока элекричества | Срабатывает мгновенно после нажатия кнопки |
  | Нажатие на кнопку охрана  |  Click2_Panel   | Чуть-чуть более грубый звук нажатия на большую кнопку сопровожденный очень легким звуком тока элекричества. | Срабатывает мгновенно после нажатия кнопки |

- **Стационарный телефон:**

  |   Состояние:    | Название звука:  |                       Описание звука:                        |                         Поче-е-ему?                          |
  | :-------------: | :--------------: | :----------------------------------------------------------: | :----------------------------------------------------------: |
  |     Звонит      |    Call_Phone    | Обычный слегка раздражающий звук трубки с характерный дребезжанием, будто телефон старый |      Кто-то звонит нам по телефону, происходит событие       |
  |   Взял трубку   | AcceptCall_Phone | Звук ты взял старую трубку телефона поднял её с места и поднес к уху | Игрок нажал на телефон и поднял трубку, происходит мгновенно |
  | Отклонил звонок | RejectCall_Phone |  Звук нажатия на кнопку с характерным звуком пищания после   |  Игрок нажал на кнопку "отклонить" телефон больше не звонит  |
  | Положил трубку  |   HungUp_Phone   | Звук ты положил трубку обратно на её место и телефон слегка пошатнулся | Игрок закончил диалог, нажал на пустое место где нет трубки, после чего кладется телефон |
  |  Трубка весит   | HangerIdle_Phone |           Звук пищания когда на трубке никого нет            | Игрок закончил диалог, но трубка все ещё находится на столе или у уха игрока. Звучит постоянно пока игрок не положет трубку обратно |

- **Список клиентов на сегодня:**

  |     Состояние:     |  Название звука:  |                       Описание звука:                        |                         Поче-е-ему?                          |
  | :----------------: | :---------------: | :----------------------------------------------------------: | :----------------------------------------------------------: |
  |   Нажал на стол    | ClickOnArea_Paper | Звук будто человек пододвинулся к столу и нырнул в кипу бумажек | Игрок нажал на Экране 2 на область где находится список клиентов на сегодня |
  |    Взял бумажку    |    Hold_Paper     | Очень короткий звук поднятия или взятия в руки листа бумаги или просто бумажки |   Игрок только нажал ЛКМ на бумажку ещё никуда не сдвинул    |
  | Передвинул бумажку |    Move_Paper     |       Звук перетаскивания или катания бумаги по столу        | Игрок зажал кнопку ЛКМ мышки на бумаге и передвигает её по экрану |
  |  Отпустил бумажку  |   Release_Paper   |       Очень короткий звук сброса листа бумаги на стол        |               Игрок отжал ЛКМ от листа бумаги                |

- **Игрушка:**

  |  Состояние:   | Название звука: |                       Описание звука:                        |                         Поче-е-ему?                          |
  | :-----------: | :-------------: | :----------------------------------------------------------: | :----------------------------------------------------------: |
  | Взял игрушку  |    Pull_Game    | Звуки будто из рюкзака достается книга или какой-то прибор, но как будто в тихую что-б никто не заметил |          Игрок достает консоль(игрушку) из кармана           |
  | Убрал игрушку |  TakeOff_Game   | Звук будто в рюкзак или пальто положили что-то небольшое и сделали это очень-очень аккуратно | Игрок переключился на другой экран либо положи обратно консоль (игрушку) в карман |
  |     Бежит     |  RunChar_Game   |       8-мибитный звук типа персонаж перебирает ножками       |         Персонаж внутри консоли (игрушки) типа бежит         |
  |    Прыгает    |  JumpChar_Game  |              8-мибитный звук прыжка как у марио              |          Персонаж внутри консоли (игрушки) прыгает           |
  |     Умер      | DeathChar_Game  |        8-мибитный звук смерти с спускающейся мелодией        | Персонаж внутри консоли (игрушки) столкнулся с препятствием и умер |
  |    Музыка     |   Song1_Game    | 8-мибитная музыка длительность секунд 30 и соединяющая начало и конец мелодии | Пока персонаж внутри консоли (игрушки) бежит и успешно преодолевает препятствия музыка играет |

- **Радио:**

  |        Состояние:         |    Название звука:    |                       Описание звука:                        |                         Поче-е-ему?                         |
  | :-----------------------: | :-------------------: | :----------------------------------------------------------: | :---------------------------------------------------------: |
  | Шум (радио не настроено)  |   NoiseDamage_Radio   | Неприятный белый шум, не очень громкий, но и не тихий, играет постоянно без перерыва | У игрока сбилась частота радио, радио не ловит радиостанцию |
  | Шум (радио настраивается) |   WhiteNoise_Radio    | Шум переключение частоты радио и улавливания звуков разных радиостанций + легкий и тихий звук "кликов" от прокрутки в онду или в другую сторону |       Игрок настраивает частоту радио крутя крутилку        |
  |     Радиостанция 1/2      | Station01Song01_Radio | Играет радиостанция слышны небольшие, но очень незначительные шумы и играет музыка |   Игрок настроился на определенную частоту и радиостанцию   |
  |      Радиостанция 3       | Station01Talk01_Radio | Играет радиостанция слышны небольшие, но очень незначительные шумы и кто-то говорит (мямлит) |   Игрок настроился на определенную частоту и радиостанцию   |

- **Кофеварка:**

  |     Состояние:      |      Название звука:      |                       Описание звука:                        |                         Поче-е-ему?                          |
  | :-----------------: | :-----------------------: | :----------------------------------------------------------: | :----------------------------------------------------------: |
  |      Работает       |     Work_CoffeMachine     | Кофемашинка запущена, она гудит и как блендер что-то медленно крутит  внутри себя "турбину". |      После нажатия на кнопки запуск кофемашина работает      |
  |  Закончила работу   | WorkSuccess_CoffeMachine  | Кофемашина "домешала" кофе и сбавляет свои обороты  издавая характерный звук окончания работы (примерно как у микроволновки) | Таймер готовки кофе подошел к концу нужно оповестит игрока об этом где бы он не находился |
  |    Наливает кофе    |  FillGlass_CoffeMachine   | Звук очень медленного и аккуратного наливания воды(кофе) в кружку | Кофемашинка закончила готовить кофе и теперь наливает его в графие |
  |  Нет ингредиентов   |  ClickError_CoffeMachine  | Звук залипшей клавиши или туго нажимаемой кнопки с характерным цифровым звуком ошибки | Игрок нажал на кнопку запуск, но не положил ингредиенты в кофемашину |
  | Нажать на запустить | ClcikSuccess_CoffeMachine | Звук нажатия клавишы или кнопки в лифте с характерным цифровым звуком успеха | Игрок нажал на кнопку запуск, ингредиенты все были положены значит кофемашинка может начать работать |

- **Графин:**

  |      Состояние:       | Название звука: |                       Описание звука:                        |                         Поче-е-ему?                          |
  | :-------------------: | :-------------: | :----------------------------------------------------------: | :----------------------------------------------------------: |
  |        Пустой         | Empty_CoffePot  |     Как-будто мизинчиком тыкнули по очень тонкому стеклу     | Игрок тыкнул по графину, но в нем ещё нет приготовленного кофе |
  |   Внутри есть кофе    |  Full_CoffePot  | Как-будто большим пальцем тыкнули по довольно прочному стеклу |         Игрок тыкнул по графину в котором есть кофе          |
  | Наливает кофе в чашку | Pours_CoffePot  |    Довольно короткий звук наливания воды в пустую кружку     | Звук воспроизводится после Full_CoffePot игрок наливает себе в чашку кофе |

- **Кружка:**

  |    Состояние:    | Название звука: |                       Описание звука:                        |                      Поче-е-ему?                       |
  | :--------------: | :-------------: | :----------------------------------------------------------: | :----------------------------------------------------: |
  |      Пустой      | Empty_CoffeCup  | Будто по плотному металлическому листу легонько тыкнули пальцем |       Игрок тыкнул на кружку, но в ней нет кофе        |
  | Внутри есть кофе |  Full_CoffeCup  |             Звук будто кто-то пьет воду (коффе)              | Игрок тыкнул на кружу и выпил 1/3 часть кофе из кружки |

- **Ингредиенты:**

  |       Состояние:        |       Название звука:       |                       Описание звука:                        |             Поче-е-ему?             |
  | :---------------------: | :-------------------------: | :----------------------------------------------------------: | :---------------------------------: |
  |   На пакетики тыкнули   |  Shake_CofSug_Ingredients   | Будто слегка встряхнули пакетик с песком (сахаром, кофе), для кофе запитчить на один тон ниже | Игрок нажал на один из ингредиентов |
  | Их положили в кофеварку | Sprinkle_CofSug_Ingredients |                                                              | Игрок нажал на один из ингредиентов |
  |     На воду тыкнули     |   Click_Water_Ingredients   |                                                              |                                     |
  |  Её налили в кофеварку  |   Pours_Water_Ingredients   |                                                              |                                     |
